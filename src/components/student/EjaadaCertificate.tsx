...
export default function EjaadaCertificate({ student }: EjaadaCertificateProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="max-w-4xl mx-auto h-screen flex items-center justify-center bg-[url('/src/pages/public/images/ejaddacertificate.png')] bg-cover bg-center relative">
  {/* Certificate Content */}
  <div className="text-center space-y-8 p-8 bg-white/90 rounded-lg shadow-lg" style={{ fontFamily: 'Noto Kufi Arabic, sans-serif' }}>
    <div className="text-xl">
      <p>تشهد جامعة التقنية والعلوم التطبيقية بنزوى بأن</p>
      <p className="text-2xl font-bold mt-4 mb-4">{student.name}</p>
      <p>قد شارك/ـت في الأنشطة والفعاليات الطلابية وحقق/ـت</p>
